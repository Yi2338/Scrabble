...
public interface GameLogger {
    ...
    /**
     * 记录字母牌交换事件
     * @param player 执行交换的玩家
     * @param exchangedTiles 被交换的字母牌列表
     */
    void logTileExchange(Object player, List<Tile> exchangedTiles);

    /**
     * 记录为空白牌指定字母的事件
     * @param player 执行指定的玩家
     * @param tile 被指定字母的空白牌
     * @param letter 指定的字母
     */
    void logBlankTileAssign(Object player, Tile tile, char letter);
     ...
     * 记录玩家字母架内容
     * @param player 玩家
     * @param tiles 字母架上的字母牌列表
     * @param event 相关联的事件（如"TURN_START"、"TURN_END"等）
     */
    void logPlayerRack(Object player, List<Tile> tiles, String event);
