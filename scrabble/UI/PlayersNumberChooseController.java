...
public class PlayersNumberChooseController {
    ...
    private void initialize() {
        ...
        // 设置按钮事件
        twoPlayersButton.setOnAction(event -> startGameWithPlayers(2));
        threePlayersButton.setOnAction(event -> startGameWithPlayers(3));
        fourPlayersButton.setOnAction(event -> startGameWithPlayers(4));
        backbutton.setOnAction(event -> handleBackButtonAction(event));
    }
